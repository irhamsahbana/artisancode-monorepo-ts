...
export const PERMISSION_MODULES = [
  ...
  { key: 'master_segmentation', label: 'Segmentasi' },
  { key: 'master_areas', label: 'Area' },
  { key: 'master_relation_status', label: 'Status Relasi' },
  { key: 'master_products', label: 'Produk' },
  { key: 'master_uoms', label: 'Satuan' },
  { key: 'master_unit_conversions', label: 'Konversi Satuan' },
