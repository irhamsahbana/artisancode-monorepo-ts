...
import { IDashboardRepo } from '@/contracts/dashboard.contract'
import { categories, customers } from '@/db/schema'
import * as Entity from '@/entities/dashboard.entity'

export function createDashboardRepo(): IDashboardRepo {
  return {
    getMetrics: async (): Promise<Entity.DashboardMetrics> => {
